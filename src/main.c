...
static void printFV(FieldValuePtr fieldValuePtr, double x, double y, double z, MagneticFieldPtr field) {
    ...
    if (field == NULL) {
        getCompositeFieldValue(fieldValuePtr, x, y, z, solenoid, symmetricTorus);
    }
    else {
...
static void testSpecialValues() {
    ...
    printFV(fieldValuePtr, .00001, -159.0, 234.0, currentField);
    printFV(fieldValuePtr, -.00001, -159.0, 234.0, currentField);
    printFV(fieldValuePtr, .01, -159.0, 234.0, currentField);
    printFV(fieldValuePtr, -.01, -159.0, 234.0, currentField);
